...
@section('content')
    <div class="container">
      <div class="row">
        <div class="col-md-5">
          <h2>Edit Picture</h2>
            <form action="{{route('panel.pictures.store')}}" method="post" enctype="multipart/form-data">
                @csrf
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" name="token" class="form-control" value="{{$token}}" aria-label="Token" aria-describedby="inputGroup-sizing-sm">
              </div>
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" name="slug" class="form-control" value="{{$slug}}" aria-label="Slug" aria-describedby="inputGroup-sizing-sm">
              </div>
